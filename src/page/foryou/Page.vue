...
<template>
    ...
    <div class="min-h-[687px] foryou-img">
        <div class="relative flex justify-center">
            <h1 class="text-[#A43D3F] text-[63.26px] py-4 font-[oswald] leading-[93.76px] font-bold">SIZ UCHUN</h1>
            <p class="text-[117.46px] leading-[138.34px] text-[#ED9FA1] font-[Freestyle] absolute top-12 left-1/2">siz
                uchun</p>
        </div>
        <ul class="grid lg:grid-cols-3 container md:grid-cols-2 grid-cols-1 gap-10 mt-20">
            <li v-for="(data, index) in productData">
                <div
                    ...
                    <div
                        class="absolute -bottom-8 left-1/2 font-bold -translate-x-1/2 rounded-full w-[69px] h-[69px] bg-white flex items-center justify-center text-[43px]  text-[#A43D3F] shadow-lg leading-none">
                        {{ data.discription }}
                    </div>
                </div>
                <div class="py-5 px-5 text-center">
                    <h3 class="text-[#A43D3F] text-[63.26px] font-bold font-[oswald] leading-[93.76px] ">
