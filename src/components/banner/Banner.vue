...
<template>
    <div class="mybg md:h-[90vh] h-[80vh] w-full p-10 z-10 relative">
        <div class="absolute bottom-0  left-0 w-full h-full z-[-1]">
            <img class=" md:block sm:h-[800px] h-[110%] md:h-[700px] bottom-0 lg:h-[900px] w-auto mx-auto absolute md:left-1/2    transform -translate-x-1/2"
